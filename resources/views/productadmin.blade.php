    ...
    <div class="container">
        <div class="row justify-content-center">
            <form method="POST" action="{{ route('productsadmin.store') }}">
                ...
                <div class="row mb-3">
                    <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Процент бонуса') }}</label>

                    <div class="col-md-6">
                        <input id="percent" type="text" class="form-control @error('percent') is-invalid @enderror"
                            name="percent" value="{{ old('percent') }}" autocomplete="percent" autofocus>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="min-height: 45em">
                                ...
                                <ul class="list-unstyled mt-3 mb-4">
                                    ...
                                    <li>
                                        <b>Процент бонуса: {{ $shipment->product->bonus_percent }} %</b>
                                    </li>
                                </ul>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li>
